#!/bin/bash
#SBATCH --job-name=10_10
#SBATCH --gres=gpu:1
#SBATCH --ntasks=8
#SBATCH --output=10_10.out
...
python $HOME/M2m/train.py --ratio 10  --decay 2e-4 --model resnet32 --dataset cifar10 --lr 0.1 --batch-size 128 --name 'ERM-RS' --warm 0 --epoch 200
python $HOME/M2m/train.py -s --ratio 10  --decay 2e-4 --model resnet32 --dataset cifar10 --lr 0.1 --batch-size 128 --name 'ERM-SMOTE' --warm 0 --epoch 200
python $HOME/M2m/train.py --no_over -c  --eff_beta 1.0 --ratio 10 --decay 2e-4 --model resnet32 --dataset cifar10 --lr 0.1 --batch-size 128 --name 'ERM-RW' --warm 0 --epoch 200
python $HOME/M2m/train.py --no_over -c  --eff_beta 0.999 --ratio 10 --decay 2e-4 --model resnet32 --dataset cifar10 --lr 0.1 --batch-size 128 --name 'ERM-CBLoss' --warm 0 --epoch 200
...
python $HOME/M2m/train.py -gen -r -c --loss_type LDAM  --eff_beta 0.999  --ratio 10 --decay 2e-4 --model resnet32 --dataset cifar10 --lr 0.1 --batch-size 128 --name 'LDAM-DRW-M2m' --beta 0.999 --lam 0.5 --gamma 0.9 --step_size 0.1 --attack_iter 10 --warm 160 --epoch 200 --net_g $HOME/M2m/checkpoint/LDAM-DRW_resnet32_norm_cifar10_10.t7
